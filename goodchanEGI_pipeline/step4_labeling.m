...
clear
load('../../archive/Lausanne2008_fsaverageDSsurf_60_125_250.mat')
% select the surface
BrainTri=Brain;
...
plot3(source_rr(:,1) * 1e3+x_shift,source_rr(:,2) * 1e3+y_shift,source_rr(:,3) * 1e3+z_shift,'r.')
...
save('labeled_brain_source.mat','lowDimVert_labels','source_xyz')
