function [network,penalizationIn, penalizationOut,minInd,allDevsReturn] = New_estBestPenalizationQUI(data,SC,allLambdas,allLambdasOut)
...
allDevsReturn = nanmean(nanmean(allDevs,4),3);
