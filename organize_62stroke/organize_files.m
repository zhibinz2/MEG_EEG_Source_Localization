...
for freq=1:5
    ...
    n_split=4; n_sr=size(sourceDataReal,2);
    ...
    datapermuted{freq} = permute(datareshaped,[2,3,1]); % split into 4 ensambles: 4x896x9300
    % compute covariance
    hilbert_dataCov{freq} = cov(sourceDataReal);
    for n=1:n_split
...
cd /home/zhibinz2/Documents/GitHub/archive/EEG_stroke_62_source_hilbert
save([num2str(subject_ID) '.mat'],'hilbert_dataCov','datapermuted_cov','datapermuted');
