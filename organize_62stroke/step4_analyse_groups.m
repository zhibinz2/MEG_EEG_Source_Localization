...
for f=1:61
    ...
    load([num2str(subj_files(f)) '.mat'],'stroke_Pcoh');
    cd /home/zhibinz2/Documents/GitHub/STROKE_P61/pcoh_p61
    save([num2str(subj_files(f)) '.mat'],'stroke_Pcoh');
end

%% save other source info
clear
